...
N=50; BE=[42 140 235 360]; Wts=[10 1]; %Closest 
...
Ptitle{1}=['IN REMEZBP1: N=' num2str(N) '  BE=[' num2str(BE) ']'];
Ptitle{2}=['Wts=[' num2str(Wts) ']'];
